...
**Junior Data Analyst** с опытом в VK и управлении розницей. Ищу позицию **junior-аналитика данных**.
...
Получить позицию junior-аналитика данных, где смогу применять навыки работы с данными для решения бизнес-задач и развиваться в продуктовой аналитике. Готов к гибридному формату или удалёнке.
